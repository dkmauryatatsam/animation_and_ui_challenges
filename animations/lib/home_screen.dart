...
import 'package:animations/animation_pages/parallax1.dart';
import 'package:animations/animation_pages/parallax2.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        children: [
          ...
          AnimationTile(
              title: "Parallax1", function: () => Get.to(const Parallax1())),
          AnimationTile(
              title: "Parallax2", function: () => Get.to(const Parallax2())),
        ],
      ),
    );
  }
